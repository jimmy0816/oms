...
BEGIN
  ...
  IF admin_role_id IS NOT NULL THEN
    -- 檢查該角色是否已有權限
    SELECT COUNT(*) INTO perm_count FROM "RolePermission" WHERE "roleId" = admin_role_id::TEXT::UUID;
...
BEGIN
  ...
  IF manager_role_id IS NOT NULL THEN
    -- 檢查該角色是否已有權限
    SELECT COUNT(*) INTO perm_count FROM "RolePermission" WHERE "roleId" = manager_role_id::TEXT::UUID;
...
BEGIN
  ...
  IF user_role_id IS NOT NULL THEN
    -- 檢查該角色是否已有權限
    SELECT COUNT(*) INTO perm_count FROM "RolePermission" WHERE "roleId" = user_role_id::TEXT::UUID;
...
BEGIN
  ...
  IF staff_role_id IS NOT NULL THEN
    -- 檢查該角色是否已有權限
    SELECT COUNT(*) INTO perm_count FROM "RolePermission" WHERE "roleId" = staff_role_id::TEXT::UUID;
...
BEGIN
  ...
  IF role_id IS NOT NULL THEN
    -- 檢查該角色是否已有權限
    SELECT COUNT(*) INTO perm_count FROM "RolePermission" WHERE "roleId" = role_id::TEXT::UUID;
